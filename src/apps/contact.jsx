						...
						<div className="col-lg-4 col-12">
							<div className="single-head">
								...
								<div className="single-info">
									...
									<ul>
										<li><a href="mailto:info.cdpc@pmd.gov.pk"> info.cdpc@pmd.gov.pk</a></li>
									</ul>
								</div>
								<div className="single-info">
									...
									<ul>
										<li>Climate Data Processing Centre <br/> Pakistan Meteorological Department <br/> Met. Complex, Block # 5, Gulistan E Jauhar.<br/> University Road, Karachi-75290. PAKISTAN</li>
									</ul>
								</div>
							</div>
						</div>
