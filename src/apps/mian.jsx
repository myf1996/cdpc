        ...
        <div className="main-section">
          <div className="row">
            <div className="col-md-12">
              <a
                href="https://public.wmo.int/en/media/press-release/wmo-verifies-3rd-and-4th-hottest-temperature-recorded-earth"
                style={{ textDecoration: "none" }}
              >
                <h6 className="main-center-heading">
                  WMO verifies Turbat maximum temperature as 4<sup>th</sup>{" "}
